...
public class ItemServiceMockImpl implements ItemService {
  ...
  public void init() {
    ...
    mapItens.put(++sequenciaId,
        new Item(sequenciaId, "Item A", "#c0392b", 90, LocalDateTime.parse("2019-07-02T08:30:00"),
            categoriaService.findById(1), categoriaService.findById(3)));
    mapItens.put(++sequenciaId,
        new Item(sequenciaId, "Item B", "#2980b9", 125, LocalDateTime.parse("2019-02-10T06:58:00"),
            categoriaService.findById(2), categoriaService.findById(4)));
    mapItens.put(++sequenciaId,
        new Item(sequenciaId, "Item C", "#27ae60", 75, LocalDateTime.parse("2019-09-01T15:50:00")));
    ...
    mapItens.put(++sequenciaId,
        new Item(sequenciaId, "Item E", "#8e44ad", 85, LocalDateTime.parse("2019-08-24T12:45:00")));
    mapItens.put(++sequenciaId,
        new Item(sequenciaId, "Item F", "#7f8c8d", 140, LocalDateTime.parse("2019-06-29T11:20:00"),
